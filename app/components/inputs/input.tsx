...
const Input: React.FC<InputProps> = ({id, errors, disabled, register, type, required, label}) => {
    return (
        <div className="w-full relative">
            <input autoComplete="off"
                   ...
                   placeholder=""
                   type={type}
                   id={id} className={`peer w-full p-4 pt-6 outline-none bg-white font-light border-2 rounded-dm transition disabled:opacity-70
